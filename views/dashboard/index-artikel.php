                    ...
                    <div class="container full-container py-5 flex flex-col gap-6">
                        <div class="card">
                            <div class="card-body flex justify-between gap-6">
                                <h6 class="text-lg text-gray-600 font-semibold">Tambah Artikel</h6>
                                <button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-md border border-transparent bg-cyan-500 text-white hover:bg-cyan-600">
                                    <a href="create-artikel.php">Tambah Artikel</a>
                                </button>
                            </div>
                        </div>
                                        ...
                                        <table class="text-left w-full whitespace-nowrap text-sm">
                                            <thead class="text-gray-700">
                                                <tr class="font-semibold text-gray-600">
                                                    ...
                                                    <th scope="col" class="p-4">Tittle</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="p-4">
                                                        <h3 class=" font-semibold text-gray-600 w-44 truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores magnam error exercitationem esse velit quasi hic officiis iste aspernatur laudantium.</h3>
                                                    </td>
                                                    <td class="p-4">
                                                        <h3 class=" font-semibold text-gray-600 w-48 truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem blanditiis quos explicabo ipsum modi totam similique, ipsa illo reiciendis nobis libero rerum eum beatae iure veniam est eaque, iusto consequatur omnis at et perspiciatis nesciunt! Cumque totam reprehenderit unde tempore.</h3>
                                                    </td>
                                                    <td class="p-4">
