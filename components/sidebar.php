        ...
        <div class="px-6 mt-8">
            <nav class=" w-full flex flex-col sidebar-nav">
                <ul id="sidebarnav" class="text-gray-600 text-sm">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link gap-3 py-2 px-3  rounded-md  w-full flex items-center hover:text-blue-600 hover:bg-blue-500" href="index-category.php">
                            <i class="ti ti-article  text-xl"></i> <span>Kategori</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link gap-3 py-2 px-3  rounded-md  w-full flex items-center hover:text-blue-600 hover:bg-blue-500" href="index-artikel.php">
                            <i class="ti ti-file-description  text-xl"></i><span>Artikel</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500" href="ganti-password.php">
                            <i class="ti ti-article  text-xl"></i> <span>Ganti Password</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500" href="akun.php">
                            <i class="ti ti-alert-circle  text-xl"></i> <span>Edit Akun</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link gap-3 py-2 px-3  rounded-md w-full flex items-center hover:text-blue-600 hover:bg-blue-500" href="kontak.php">
                            <i class="ti ti-alert-circle  text-xl"></i> <span>Kontak</span>
                        </a>
                    </li>
